...
\begin{abstract}
  ...
  \textsc{LLAMIA}, trained under this paradigm matches or exceeds both dedicated task specialists and the strongest verbalization-based pipeline, GPT-5.1 with tool access, across all benchmark tasks, and generalizes out-of-distribution where these specialists collapse.
\end{abstract}
