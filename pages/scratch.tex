...
% A: Unlike LLaVA-style static projection, our approach conditions the LLM on
%    fresh latent tokens at each state via InvokeAgent, trained end-to-end with
%    GRPO. The key distinction is that invocation timing and frequency are
%    learned, not fixed.
...
%   - Static projection (LLaVA-style, fixed invocation)
...
% 2. The InvokeAgent ablation is the strongest result
...
% 6. RL-trained invocation (InvokeAgent) + continuous latent channel is the genuine novelty
