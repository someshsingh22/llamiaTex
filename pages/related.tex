...
our evaluated benchmark and scale range, indicating that verbalization is a structural bottleneck for LLM--agent
collaboration in the regimes we test.
