...
% =============================================================================
\somesh{Fix these axes as human engine collaboration, first make a table of datasets and sources. Then datastraining tasks train/test size, metrics, and t}
...
Splits marked~\itwmark{} are \emph{out-of-distribution (OOD)}: the test distribution is
absent or shifted relative to Stage-2 training, so generalization must come from
internalized representations rather than memorization.
