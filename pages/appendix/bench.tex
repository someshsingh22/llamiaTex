...
\somesh{1. Use LLAMIA Bench instead of In the wild 2. Some columns (Instruct Conditioned Planning are overflowing 3. For repeated items like Lichess Puzzles use a multirow or somehow combine them. 4. Dont repear Move annotation - Move annotation etc 5. Use test set size, wherever you know and can find use test set size in other places add tbd. For task experts use MAIA in Behavior Cloning. No task expert in interest prediction, but write in the paragraph properly that . For difficulty use https://arxiv.org/pdf/2410.11078  )}
\caption{%
...
Difficulty Estimation
  & Lichess Puzzles\textsuperscript{\textdagger}~\cite{lichess2024puzzles}
  & 4M\,/\,random
  & CF-270M~\cite{XXX} \\
\rowcolor{clrPuzzle}
Interest Estimation
...
%% ── BEHAVIOR CLONING ─────────────────────────────────────────────────────────
\rowcolor{clrBC}
\multicolumn{3}{l}{\enspace\small\textbf{Behavior Cloning}} \\
\rowcolor{clrBC}
Maia (Elo buckets)
...
%% ── PUZZLE UNDERSTANDING ─────────────────────────────────────────────────────
\rowcolor{clrPuzzle}
\multicolumn{3}{l}{\enspace\small\textbf{Puzzle Understanding}} \\
\rowcolor{clrPuzzle}
Difficulty Estimation
...
%% ── MOVE ANNOTATION ──────────────────────────────────────────────────────────
\rowcolor{clrAnnot}
\multicolumn{3}{l}{\enspace\small\textbf{Move Annotation}} \\
\rowcolor{clrAnnot}
Move Annotation
...
%% ── GAME COMMENTARY ──────────────────────────────────────────────────────────
\rowcolor{clrComm}
\multicolumn{3}{l}{\enspace\small\textbf{Game Commentary}} \\
\rowcolor{clrComm}
Game Commentary
...
%% ── INSTRUCTION-CONDITIONED PLANNING ─────────────────────────────────────────
\rowcolor{clrICP}
\multicolumn{3}{l}{\enspace\small\textbf{Instruction-Conditioned Planning}} \\
\rowcolor{clrICP}
Strategic motifs
...
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{p{3.2cm} p{6.8cm} p{5.4cm}}
\toprule
\textbf{Category} & \textbf{Description} & \textbf{Detection} \\
\midrule
Endgames
  & King-and-pawn, rook, queen, opposite-colour bishop endings; Lucena/Philidor positions; minor-piece vs.\ pawn.
  & Total material (excl.\ kings) $<13$\,pts. \\
Pawn Structures
  & Isolated, doubled, backward, and passed pawns; pawn chains; hanging pawns.
  & Structural-analysis API; target structure persists $\geq$3 consecutive moves. \\
Tactical Blunders
  & Knight forks, pins, overloaded defenders, mate-in-$K$ ($K\!\leq\!5$), king safety failures.
  & Engine evaluation shift $\geq$400\,cp within 2 moves. \\
Piece Coordination
  & Two rooks vs.\ queen; knight\,+\,bishop vs.\ rook; bishop pair vs.\ bishop\,+\,knight; rook on open file vs.\ unconnected rooks.
  & Material configuration matches the target imbalance. \\
Repetition Traps
  & Forced threefold-repetition sequences.
  & Position hash appears 3 times with the opponent to move. \\
\bottomrule
\end{tabular}
\end{adjustbox}
