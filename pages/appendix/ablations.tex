...
\caption{%
  ...
  gauntlet protocol of \cref{sec:app_results_gameplay_elo}.
...
\begin{table}[h]
\centering
\caption{\textbf{Agent-size ablation.} LLAMIA-14B performance with different Lc0 backends. BC, Commentary, and ICP are representative tasks; Avg.\ is the unweighted mean across all seven LLAMIA-Bench tasks. Stronger agents yield monotonically better scores.}
...
\toprule[1.2pt]
\textbf{Agent} & \textbf{Elo (no search)} & \textbf{BC} & \textbf{Comm.} & \textbf{ICP} & \textbf{Avg.} \\
\midrule
T72   & $\sim$2000 & 44 & 52 & 28 & 38.7 \\
T80   & $\sim$2200 & 49 & 62 & 37 & 46.3 \\
T82   & 2292       & 51 & 66 & 40 & 48.9 \\
BT3   & $\sim$2500 & \valgood{53} & \valgood{71} & \valgood{44} & \valgood{51.7} \\
BT4   & $\sim$2810 & \valbest{56} & \valbest{75} & \valbest{47} & \valbest{56.9} \\
\bottomrule[1.2pt]
\end{tabular}
\end{adjustbox}
\end{table}

Stronger agents monotonically improve LLAMIA across the representative tasks and the seven-task average, indicating that the projected representation preserves capability-relevant information. The trend does not rely on BT4 alone: T72 and T80 follow the same ordering on behavior cloning, commentary, and instruction planning under the identical training recipe.
...
\begin{table}[h]
\centering
\caption{\textbf{Projection token count ablation.} LLAMIA-14B with varying $k$. BC, Commentary, and ICP are representative tasks; Avg.\ is the unweighted mean across all seven LLAMIA-Bench tasks. Performance saturates at $k{=}32$, which is used throughout.}
...
4   & 48 & 58 & 30 & 45.1 & 680 \\
8   & 51 & 65 & 37 & 49.7 & 720 \\
16  & \valgood{54} & \valgood{73} & \valgood{44} & 54.9 & 790 \\
32  & \valbest{56} & \valbest{75} & \valbest{47} & \valbest{56.9} & 920 \\
64  & 56 & 75 & 47 & \valgood{56.7} & 1180 \\
\bottomrule[1.2pt]
\end{tabular}
\end{adjustbox}
\end{table}
